...
<div class="page">
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <a href="{{ route('admin.orders.create') }}" class="btn btn-md btn-icon btn-primary btn-round">
    ...
    $(function() {
        $('.datatable').DataTable({
            ...
            columns: [
                ...
                { data: 'customer.nickname', name: 'customer.nickname' },
